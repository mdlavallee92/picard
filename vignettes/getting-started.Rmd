---
title: "Getting Started with picard"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with picard}
...
picard is an R package designed as an RWE Pipelining Tool favoring OHDSI tools. Like its namesake, picard will allow RWE researchers to explore strange new worlds within their data, seeking out new patterns and analyses, and boldly going where no researcher has gone before!
...
The `picard` package begins by initializing a Ulysses Repo. This is a standard repo structure to conduct an RWE pipeline using OHDSI tools. This is a maturation of the `Ulysses` package which was retired due to technical advances and reframing of the use-case as a pipeline tool.
