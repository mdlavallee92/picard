...
binds raw results with metadata, migrations handle data wrangling tasks
that weren’t necessary during execution:
...
for later querying (e.g., `$getCohortsByTag()`, `$getCohortsByLabel()`).
...
6.  Use CohortManifest methods to query cohorts: `$getCohortById(1)`,
    `$getCohortsByTag("category: Disease Populations")`
...
[`orchestratePipelineExport()`](https://ohdsi.github.io/picard/reference/orchestratePipelineExport.md)
and processed into various formats for dissemination:
