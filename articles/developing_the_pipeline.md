...
**For Cohorts:** Use the interactive editor to add your study
populations:
...
This opens a Shiny app where you can add cohort metadata without editing
CSV files directly.
...
detailed guidance on importing from ATLAS and managing manifests.
...
|-----------------|------------------------------------------------------------------------------------------------------------|------------------------------------------------|
| **Setup**       | [`launchCohortsLoadEditor()`](https://ohdsi.github.io/picard/reference/launchCohortsLoadEditor.md)         | Interactive cohort metadata editor             |
| **Setup**       | [`launchConceptSetsLoadEditor()`](https://ohdsi.github.io/picard/reference/launchConceptSetsLoadEditor.md) | Interactive concept set editor                 |
